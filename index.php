...
<div class="container">
  ...
  <header class="hero">
    ...
    <div class="hero-text-container">
      <img class="hero-text-container-img bg-main"
        src="<?php echo get_theme_file_uri('/assets/design/home-hero-mobile-logo.png') ?>">
  ...
  <main class="intro grid">
    <div class="row intro-container">
      <figure class="col-1x2-md intro-banner">
        ...
        <img class="intro-banner-img  bg-main"
          src="<?php echo get_theme_file_uri('/assets/design/MQgraph02-comp.png') ?>" alt="banff">
      </figure>
  ...
  <section class="projects">
    <div class="row projects-title">
      <h2 class="projects-title-text hero-tileV1">Our Work</h2>
    </div>
    ...
    <div class="row swiper" style="cursor: -moz-grab;">
      <div class="swiper-container">
        ...
        <div class="swiper-pagination" id="swiper-pagination-1075">
  ...
  <section class="transform"
    style="background-image: url(<?php echo get_theme_file_uri('/assets/design/c_action_bg.jpg') ?>);">
    <h2 class="transform-title hero-tileV2">Transform your brand with</h2>

    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
      class="transform-svg" x="0px" y="0px" viewBox="0 0 207.3 106.3" style="enable-background:new 0 0 207.3 106.3;"
      ...
      <g filter="url(#transform-dropshadow)">
        <polygon class="st0 transform-svg-line transform-svg-line-1" points="116.5,5.9 148.1,5.9 114.5,98.8 82.9,98.8 "
          style="transform:translate(0)">
        </polygon>
        <polygon class="st0 transform-svg-line transform-svg-line-2" points="77.4,5.9 109,5.9 75.4,98.8 43.8,98.8 "
          style="transform:translate(0)">
        </polygon>
        <polygon class="st0 transform-svg-line transform-svg-line-3" points="38.2,5.9 69.9,5.9 36.3,98.8 4.6,98.8 "
          style="transform:translate(0)">
        </polygon>
        <path class="st0 transform-svg-line transform-svg-q"
          d="M177.6,98.8h26.6l-18.1-18.4c5-7.8,7.8-17.1,7.6-27.1c-0.4-16.3-8.8-30.5-21.3-38.9c0,0-0.1,0-0.1-0.1  c-0.5-0.3-1-0.6-1.4-0.9c-4.7-3-10-5.1-15.6-6.3l-7.3,20.1c10.9,1.1,20.4,8.8,23.5,19.3c3.2,10.6-0.6,22.3-9.2,29.2  c-4.8,3.8-10.8,5.9-16.9,5.9c-5.7,0-10.9-1.7-15.3-4.7l-7.2,20.1c0.6,0.3,1.3,0.7,1.9,1c0.3,0.1,0.6,0.3,0.9,0.4  c0.5,0.2,0.9,0.4,1.4,0.6c0.5,0.2,1,0.4,1.5,0.6c0.2,0.1,0.3,0.1,0.5,0.2c5.4,2,11.3,3,17.4,2.9c9.9-0.2,19-3.4,26.5-8.7L177.6,98.8  z"
          style="transform:translate(0)">
        </path>
      </g>
    </svg>
  ...
  <section class="membership grid">
    ...
    <div class="row membership-container">
      <div class="col-1x2-sm membership-badge">
        <img class="membership-badge-img " src="<?php echo get_theme_file_uri('/assets/design/c_chamber_logo.jpg') ?>"
          alt="Calgary Chamber">
      </div>

      <div class="col-1x2-sm membership-badge">
        <img class="membership-badge-img" src="<?php echo get_theme_file_uri('/assets/design/made_calgary_logo.jpg') ?>"
          alt="Made in Calgary">
      </div>
    </div>
  </section>
